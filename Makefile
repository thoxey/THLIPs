#############################################################################
# Makefile for building: Thlips.app/Contents/MacOS/Thlips
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  Thlips.pro
# Template: app
# Command: /Users/thoxey/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile Thlips.pro
#############################################################################
...
CFLAGS        = -pipe -g -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -g -std=gnu++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -isystem /usr/local/include -I../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk/System/Library/Frameworks/AGL.framework/Headers -I../../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/thoxey/Qt/5.7/clang_64/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Thlips1.0.0
DISTDIR = /Users/thoxey/Desktop/THLIPs/obj/Thlips1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.8 -Wl,-rpath,/Users/thoxey/Qt/5.7/clang_64/lib
LIBS          = $(SUBLIBS) -F/Users/thoxey/Qt/5.7/clang_64/lib -framework QtWidgets -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL 
...
DIST          = ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		Thlips.pro include/exporter.h \
		include/flipSim.h \
		include/MACGrid.h \
		include/utils.h src/exporter.cpp \
		src/flipSim.cpp \
		src/MACGrid.cpp \
		src/main.cpp \
		src/utils.cpp
...
$(TARGET):  $(OBJECTS)  
	@test -d Thlips.app/Contents/MacOS/ || mkdir -p Thlips.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Thlips.pro ../../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile Thlips.pro
...
Thlips.app/Contents/PkgInfo: 
	@test -d Thlips.app/Contents || mkdir -p Thlips.app/Contents
	@$(DEL_FILE) Thlips.app/Contents/PkgInfo
	@echo "APPL????" > Thlips.app/Contents/PkgInfo
Thlips.app/Contents/Resources/empty.lproj: 
	@test -d Thlips.app/Contents/Resources || mkdir -p Thlips.app/Contents/Resources
	@touch Thlips.app/Contents/Resources/empty.lproj
	
Thlips.app/Contents/Info.plist: 
	@test -d Thlips.app/Contents || mkdir -p Thlips.app/Contents
	@$(DEL_FILE) Thlips.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Thlips,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,Thlips,g" -e "s,@LIBRARY@,Thlips,g" -e "s,@TYPEINFO@,????,g" ../../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >Thlips.app/Contents/Info.plist

all: Makefile \
		Thlips.app/Contents/PkgInfo \
		Thlips.app/Contents/Resources/empty.lproj \
		Thlips.app/Contents/Info.plist $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/exporter.h include/flipSim.h include/MACGrid.h include/utils.h $(DISTDIR)/
	$(COPY_FILE) --parents src/exporter.cpp src/flipSim.cpp src/MACGrid.cpp src/main.cpp src/utils.cpp $(DISTDIR)/
